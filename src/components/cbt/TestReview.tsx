  ...
  return (
    <div className="space-y-8 mt-12">
      <div className="flex items-center gap-4 mb-6">
        <h2 className="text-2xl font-black text-slate-900">Detailed Review</h2>
          ...
          return (
            <div 
              ...
              className={`premium-card p-6 md:p-8 rounded-3xl border-2 transition-all ${
                ...
                isSkipped ? "border-slate-100 bg-slate-50/50" : 
            ...
            >
              <div className="flex justify-between items-start mb-6 pb-6 border-b border-slate-100">
                <div className="flex items-center gap-3">
                  ...
                  {isSkipped && <MinusCircle className="w-5 h-5 text-slate-400" />}
                </div>
                <span className="text-slate-500 font-medium text-sm bg-white px-3 py-1 rounded-lg shadow-sm border border-slate-100">
                  Marks: {q.marks || 1}
                </span>
              </div>
