  ...
  return (
    <div>
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          <h1 className="text-3xl font-black text-foreground">Payment Ledger</h1>
          <p className="text-muted-foreground mt-1 text-sm">Automated transactions powered by Razorpay</p>
        </div>
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
          ...
          <Button 
            onClick={exportToCSV} 
            variant="outline" 
            className="gap-2 rounded-xl text-sm font-semibold border-border shadow-sm text-foreground hover:bg-secondary"
          >
      ...
      {loading ? (
        ...
        <div className="text-center py-24 border-2 border-dashed border-border rounded-3xl bg-secondary/50">
          ...
          <h3 className="text-xl font-bold text-muted-foreground mb-2">No {filter === "all" ? "" : filter} payments</h3>
          <p className="text-muted-foreground text-sm">When students submit payment proofs, they'll appear here.</p>
        </div>
      ) : (
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <div className="flex flex-wrap gap-x-5 gap-y-1 text-sm text-muted-foreground">
                        <span className="flex items-center gap-1.5">
                          ...
                          <span className="font-semibold text-foreground">{p.studentName}</span>
                      ...
                      <div className="flex items-center gap-1.5 text-sm">
                        ...
                        <span className="font-mono bg-secondary text-foreground px-2 py-0.5 rounded-lg text-xs font-bold tracking-wider">
                          {p.txnId}
                        </span>
                      </div>
